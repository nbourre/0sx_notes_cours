...
1. Réalisez l'[Exemple de code de base](C04a_fonction_analogRead.md/#base)
...
3. Réalisez le montage de l'exemple [Sélection de DEL](C04a_fonction_analogRead.md/#selection-de-del) avec le code de l'exemple [Exemple de code avec la fonction `map()`](C04a_fonction_analogRead.md/#exemple-de-code-avec-la-fonction-map).

## Exercices - avec `analogWrite()`
- Avec le montage de l'[exercices](C04b_fonction_analogWrite.md/#pwm--à-quoi-ça-sert) #4 des notes sur `analogRead`, faire varier des DEL en utilisant la fonction `analogWrite()`.
