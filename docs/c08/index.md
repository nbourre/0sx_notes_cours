...
## Contenu
- [Communication série : lecture](./c08a_serial_read/index.md)
- [Initiation à la programmation orientée objet](./c08b_poo_base/index.md)
- [Unité de puissance](./c08c_psu/index.md)