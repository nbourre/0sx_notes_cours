...
En entrée, il y a deux ports d'alimentation. Le port DC jack qui accepte une tension de 6.5V à 12V. Le port USB est toujours de 5V. 

!!! note "Technicalité"
    Le format du DC jack est de 5.5mm x 2.1mm et un port USB. 

En sortie, le module de puissance peut fournir une tension de 3.3V ou 5V. Le module de puissance peut fournir jusqu'à 700mA de courant.
...
Ensuite, on peut l'alimenter avec le port USB ou encore un DC jack de 5.5mm x 2.1mm. Dans votre kit, vous avez un connecteur pour batterie de 9V. Vous pouvez l'utiliser pour alimenter le module de puissance.

> **Note :** Vous pouvez aussi utiliser un adaptateur secteur qui fournit une tension entre 5V et 12V pour alimenter le module de puissance. Référez-vous à la fiche signalétique de l'adaptateur pour connaître la tension de sortie de celui-ci. (Voir le [cours C03A](../../c03/C03c_branchement_base.md) pour plus de détail)
> 
...
![alt text](assets/breadboard_psu_bb.png)
...
!!! danger "Attention!"
    Il ne faut pas se tromper de polarité, car on peut griller l'Arduino!
